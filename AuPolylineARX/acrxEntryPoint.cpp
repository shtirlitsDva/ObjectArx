...
public:
	...
	static void ADSKMyGroupAuPolylineCreate()
	{
		...
		//AuPolyline entity
		//Wrap pointer in smartpointer
		AuPolyline* pLOrdinaryPointer = new AuPolyline();
		...
		for (int i = 0; i < nSides; i++)
			pLs->addVertexAt(i, AcGePoint2d(10 * cos(i * incAngle), 10 * sin(i * incAngle)));

		//Set polyline as closed
		pLs->setClosed(Adesk::kTrue);
	...
	// function of the CAuPolylineARXApp class.
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CAuPolylineARXApp, ADSKMyGroup, MyCommand, MyCommandLocal, ACRX_CMD_MODAL)
	...
	//// ACED_ARXCOMMAND_ENTRY_AUTO(CAuPolylineARXApp, ADSKMyGroup, MyPickFirst, MyPickFirstLocal, ACRX_CMD_MODAL | ACRX_CMD_USEPICKSET)
	...
	//// ACED_ARXCOMMAND_ENTRY_AUTO(CAuPolylineARXApp, ADSKMyGroup, MySessionCmd, MySessionCmdLocal, ACRX_CMD_MODAL | ACRX_CMD_SESSION)
	...
	//// or integer.
	//// ACED_ADSFUNCTION_ENTRY_AUTO(CAuPolylineARXApp, MyLispFunction, false)
...
//ACED_ADSSYMBOL_ENTRY_AUTO(CAuPolylineARXApp, MyLispFunction, false)
